...
ref_DEM_HEF = path + 'ASTER_processing/Hinterheis/REF_DEM_MASK/DEM_REF.tif'

shp_all_glaciers = path+'EXP1_from_participants\shp\glaciers_around_HEF.shp'
...
#    print(participant)
    for dh_files in dic_HEF[participant]['path_dh']:
        N+=1
...
for participant in list_participants:
    ...
    for dh_files in dic_HEF[participant]['path_dh']:
        ...
        reproj_imB_matching_imA(ref_DEM_HEF, dh_files, dest_file, method = 'bilinear')
