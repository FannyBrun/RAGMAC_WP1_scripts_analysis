...
#                     path_HEF + 'Exp1_HEF_Dussaillant/Exp1_HEF_Dussaillant_longrun/IDUSSAILLANT_AT_HINTEREISFERNER_2019.75_2010.75_CTL_results.csv',
          ...
          'Piermattei' :   
             ...
             'path_results': [path_HEF + 'Exp1_HEF_Piermattei/_Piermattei_AT_Hintereis_20091003_20190929_ASTER_results.csv',
                              path_HEF + 'Exp1_HEF_Piermattei/_Piermattei_AT_Hintereis_20101001_20190929_ASTER_results.csv',
                              path_HEF + 'Exp1_HEF_Piermattei/_Piermattei_AT_Hintereis_20101001_20190929_TDX_results.csv',
                              path_HEF + 'Exp1_HEF_Piermattei/_Piermattei_AT_Hintereis_20110924_20200911_TDX_results.csv',
                              path_HEF + 'Exp1_HEF_Piermattei/_Piermattei_AT_Hintereis_20120216_20190206_TDX_results.csv',
                              path_HEF + 'Exp1_HEF_Piermattei/PIERMATTEI_AT_HINTEREIS_20190929_20101001_SEAS_results.csv'],
             'path_errors': []
             },
          'Sommer' : 
...
dic_VES = {'Dehecq' : 
          ...
          'Piermattei' : 
            {'path_dh': [path_VES + 'Exp1_VES_Piermattei/Piermattei_Vestisen_DEMdiff/' + x for x in os.listdir(path_VES + 'Exp1_VES_Piermattei/Piermattei_Vestisen_DEMdiff/') if x.endswith('.tif')],
             'path_results': [path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20060811_20190728_RGI600800287_ASTER_results.csv',
                              path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20060811_20190728_RGI600801641_ASTER_results.csv',
                              path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20060811_20190728_RGI600801657_ASTER_results.csv',
                              path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20080902_20200810_RGI600800287_ASTER_results.csv',
                              path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20080902_20200810_RGI600801641_ASTER_results.csv',
                              path_VES + 'Exp1_VES_Piermattei/_Piermattei_NO_Vestisen_20080902_20200810_RGI600801657_ASTER_results.csv'],
             'path_errors': []
             },
          'Sommer' : 
